...
S21-S24  Vidéo, dossier technique, validation finale
```
...
| M7 Vidéo finalisée | S22 | 15-20 min |
| M8 Validation finale | S24 | dossier projet + retours d’expérience |

Les dépendances critiques concernent surtout l’architecture backend/frontend, le POC Odoo, le pipeline Power BI, la formation utilisateurs et la disponibilité d’une bêta stable pour la vidéo.
