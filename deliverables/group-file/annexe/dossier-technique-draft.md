...
La section 5 forme le cœur technique du dossier. Avec 73 points sur 156 (47 % de la note totale du dossier), elle porte la pondération la plus forte. Elle couvre 13 critères qui embrassent toutes les dimensions de la qualité d'une solution logicielle professionnelle : cohérence architecturale, justification des choix technologiques, stratégie de tests, conformité réglementaire, accessibilité, performance environnementale, documentation utilisateur et gouvernance d'évolution. La maîtrise de cette section conditionne l'obtention d'une note globale satisfaisante. Elle requiert une articulation rigoureuse entre les choix techniques documentés et les besoins identifiés dans la section 2.
...
**Poids de la conduite du changement.** Le critère D-03 (Programme de conduite du changement, 10 points) fait partie des 7 critères P0 de la grillé d'évaluation, au même niveau que la démonstration du MVP (V-03, 10 points). Cette pondération reflète une réalité du terrain connue des évaluateurs : la majorité des projets de transformation numérique échouent pour des raisons humaines. Un système non adopté est un système inutile, quelle que soit sa qualité intrinsèque. L'équipe conçoit donc le programme de conduite du changement dès la phase de cadrage (S1-S2) et le pilote en parallèle du développement technique sur l'ensemble des 24 semaines.
...
**Rôle de cette section.** Sur un projet académique de 24 semaines mené en binôme, la dimension individuelle est souvent la partie la moins travaillée, on se concentré sur le collectif (MVP, dossier groupe, vidéo) et on bâcle l'analyse personnelle. Les 8 points de cette section représentent 5 % de la note totale (8/156 du dossier). Cette partie aide surtout l'évaluateur à distinguer deux membres d'une même équipe. Une analyse superficielle et identique pour les deux membres sera sanctionnée ; une analyse personnelle, ancrée dans des expériences concrètes et distinctes, sera récompensée.
